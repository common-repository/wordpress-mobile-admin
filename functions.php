...
if(!function_exists('architect_admin_options_page'))
{
	function architect_admin_options_page()
	{
		...
		{
			echo '<div class="updated" style="background:#F24318;color:#000;border-color:#B23112;"><p><strong>You haven\'t saved your Wapple Architect Dev Key, get one today from <a href="http://wapple.net/signup/wordpress?trk=wpma" style="color:#000;">Wapple</a></strong>. Once you have it, enter it below</p></div>';
		}
